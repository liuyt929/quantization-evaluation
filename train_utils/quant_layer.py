...
class QuantMLP(nn.Module):
    def __init__(self, org_module: nn.Module, config: LlamaConfig, args,ptq_args):
        super().__init__()
...
class QuantAttention(nn.Module):
    def __init__(self, org_module: LlamaAttention, config: LlamaConfig, args,ptq_args):
        super().__init__()
...
class QuantDecoderLayer(nn.Module):
    def __init__(self, config: LlamaConfig, ori_layer: LlamaDecoderLayer, args,ptq_args):
        super().__init__()
        self.hidden_size = config.hidden_size
